...
export function TatumBadge({ variant = "default", className = "" }: TatumBadgeProps) {
  if (variant === "banner") {
    return (
      <div className={`flex items-center gap-3 px-4 py-2.5 rounded-xl bg-gradient-to-r from-cyan-500/8 to-white/[0.02] border border-cyan-500/15 ${className}`}>
        <div className="flex items-center gap-2">
          ...
          <span className="font-display font-semibold text-white/80 text-sm">Tatum</span>
        </div>
  ...
  if (variant === "compact") {
    return (
      <div className={`inline-flex items-center gap-1.5 text-[10px] font-mono text-white/80/70 ${className}`}>
  ...
  return (
    <div className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-cyan-500/8 border border-cyan-500/15 text-xs ${className}`}>
      <Zap className="w-3.5 h-3.5 text-white/80" />
      <span className="text-white/80 font-medium">Powered by Tatum</span>
    </div>
  );
}
...
export function WalrusBadge({ variant = "default", className = "" }: TatumBadgeProps) {
  if (variant === "banner") {
    return (
      <div className={`flex items-center gap-3 px-4 py-2.5 rounded-xl bg-gradient-to-r from-magenta-500/8 to-white/[0.02] border border-magenta-500/15 ${className}`}>
        <div className="flex items-center gap-2">
          ...
          <span className="font-display font-semibold text-white/50 text-sm">Walrus</span>
        </div>
        <div className="w-px h-4 bg-white/10" />
        <span className="text-white/30 text-xs">Decentralized Storage</span>
        <div className="ml-auto flex items-center gap-1.5">
          <div className="w-1.5 h-1.5 rounded-full bg-cyan-400 animate-pulse" />
          <span className="text-white/80 text-[10px] font-medium">VERIFIED</span>
        </div>
      </div>
    );
  }
  ...
  if (variant === "compact") {
    return (
      <div className={`inline-flex items-center gap-1.5 text-[10px] font-mono text-white/50/70 ${className}`}>
  ...
  return (
    <div className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-lg bg-magenta-500/8 border border-magenta-500/15 text-xs ${className}`}>
      <Database className="w-3.5 h-3.5 text-white/50" />
      <span className="text-white/50 font-medium">Stored on Walrus</span>
    </div>
  );
}
...
export function TechStackBadges({ className = "" }: { className?: string }) {
  return (
    <div className={`flex items-center gap-3 ${className}`}>
      ...
      <div className="w-px h-3 bg-white/10" />
      <div className="inline-flex items-center gap-1.5 text-[10px] font-mono text-white/80/70">
