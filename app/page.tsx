      ...
      <section className="relative z-10 py-24">
        <div className="max-w-5xl mx-auto px-8">
          <div className="text-center mb-16">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-magenta-500/10 to-magenta-500/10 border border-white/[0.06] text-xs text-white/30 font-bold uppercase tracking-[0.15em] mb-6">
            ...
            <h2 className="font-display font-black text-4xl md:text-5xl text-white tracking-tight">
              ...
              <span className="bg-gradient-to-r from-magenta-400 to-magenta-300 bg-clip-text text-transparent">lose money</span>
            </h2>
          </div>
          <div className="grid md:grid-cols-2 gap-4 max-w-3xl mx-auto">
            {[
              ...
              <div key={title} className="group flex items-start gap-4 p-6 rounded-2xl border border-white/[0.04] bg-gradient-to-br from-white/[0.02] to-magenta-500/[0.02] hover:border-magenta-500/20 transition-all duration-300">
        ...
        <div className="max-w-5xl mx-auto px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="font-display font-black text-4xl md:text-5xl text-white tracking-tight">
              ...
              <span className="bg-gradient-to-r from-cyan-400 to-magenta-400 bg-clip-text text-transparent">a verdict</span>
            </h2>
          </div>
          <div className="grid md:grid-cols-2 gap-4 max-w-3xl mx-auto">
            {[
              { icon: <Zap className="w-5 h-5" />, title: "Real-time via Tatum", desc: "Balance, objects, transactions live from Sui mainnet.", gradient: "from-cyan-500/10 to-cyan-500/5", border: "hover:border-cyan-500/20", iconColor: "text-cyan-400" },
              { icon: <Database className="w-5 h-5" />, title: "Historical via Walrus", desc: "Cross-reference with 11TB+ of blockchain history.", gradient: "from-magenta-500/10 to-magenta-500/5", border: "hover:border-magenta-500/20", iconColor: "text-magenta-400" },
              { icon: <Lock className="w-5 h-5" />, title: "Verifiable Proof", desc: "Every analysis stored on Walrus immutable and shareable.", gradient: "from-cyan-500/10 to-cyan-500/5", border: "hover:border-cyan-500/20", iconColor: "text-cyan-400" },
              { icon: <GitBranch className="w-5 h-5" />, title: "Trust Graph", desc: "Trace fund flow patterns and detect suspicious clusters.", gradient: "from-magenta-500/10 to-magenta-500/5", border: "hover:border-magenta-500/20", iconColor: "text-magenta-400" },
        ...
        <div className="max-w-4xl mx-auto px-8">
          ...
          <div className="max-w-lg mx-auto space-y-10">
            {[
              ...
              { num: "03", title: "Get verdict + share proof", desc: "On-chain certificate stored on Walrus.", color: "from-cyan-400 to-magenta-400" },
      ...
      <section className="relative z-10 py-24 border-t border-white/[0.04]">
        <div className="max-w-5xl mx-auto px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="font-display font-black text-4xl md:text-5xl text-white tracking-tight">
              Built for <span className="bg-gradient-to-r from-cyan-400 to-magenta-400 bg-clip-text text-transparent">everyone on Sui</span>
            </h2>
          </div>
          <div className="grid md:grid-cols-2 gap-4 max-w-3xl mx-auto">
            {[
              ...
              { icon: <Users className="w-5 h-5" />, title: "P2P Traders", question: "Is this wallet clean?", gradient: "from-cyan-500/10 to-cyan-500/5", border: "hover:border-cyan-500/20", iconColor: "text-cyan-400" },
              { icon: <Shield className="w-5 h-5" />, title: "New Users", question: "Where do I start?", gradient: "from-magenta-500/10 to-magenta-500/5", border: "hover:border-magenta-500/20", iconColor: "text-magenta-400" },
          ...
          <div className="relative rounded-2xl border border-white/[0.04] bg-gradient-to-br from-white/[0.02] via-white/[0.01] to-cyan-500/[0.02] p-10 overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
                {[
                  { label: "Tatum", sub: "Sui RPC & APIs", icon: <Zap className="w-6 h-6" />, color: "text-cyan-400" },
                  { label: "Walrus", sub: "Storage", icon: <Database className="w-6 h-6" />, color: "text-magenta-400" },
                  { label: "Sui", sub: "Contracts", icon: <Globe className="w-6 h-6" />, color: "text-cyan-400" },
                  { label: "Groq", sub: "AI Agent", icon: <Activity className="w-6 h-6" />, color: "text-magenta-400" },
      ...
      <footer className="relative z-10 border-t border-white/[0.04] py-10">
        <div className="max-w-5xl mx-auto px-8 flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-8 text-xs text-white/15">
            ...
            <a href="https://sui.io" target="_blank" rel="noopener noreferrer" className="hover:text-cyan-400 transition-colors font-bold">Sui</a>
          </div>
        </div>
      </footer>
    </div>
